                ...
                <div class="container-fluid p-0">
                    ...
                    <div class="row mb-2">
                        <div class="col-12 col-md-6">
                            <h1 class="h3 mb-3" id="cotizacion-title" folder="historial_cotizaciones">Historial de cotizaciones</h1>
                        </div>
                                ...
                                <div class="card-header">
                                    <div class="row">
                                        <div class="col-12 col-md-10">
                                            <h5 class="card-title mb-0">Lista de cotizaciones emitidas</h5>
                                        </div>
