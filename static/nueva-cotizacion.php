...
<div id="area-loading">
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0" id="main-content">
                        ...
                        <?php
                        include "vistas/nueva_cotizacion/seleccionar-tipo-venta.php";
                        ?>
    ...
    <!-- Mis scripts -->
    <script src="js/nueva_cotizacion/seleccionar-cliente.js"></script>
    <script src="js/nueva_cotizacion/seleccionar-producto.js"></script>
    <script src="js/nueva_cotizacion/preventa.js"></script>
    <script src="js/nueva_cotizacion/registro-ordenes.js"></script>
    ...
    <script src="js/reportes/plantilla-reporte-cotizacion-pdf.js"></script>
    <script>
