$(document).ready(function () {
    ...
    let sucursal_id = $("#user-data").attr("id_sucursal");
      tabla = $('#example').DataTable({
          ...
          serverSide: true,
          ajax:{
              url: '../servidor/historial_cotizaciones/server_processing.php?sucursal_id=' + sucursal_id,
              dataType: 'json'
          },
          responsive: true,
          order: [0, 'desc'],
          columns:  [
              ...
              { data:null, title:'tipo', render(data, row){
                switch(data[8]){
                  case '1': type = 'Cotización <b style="color: tomato;">sin</b> instalación'; break;
                  case '2': type = 'Cotización <b style="color: #009c8c;">con</b> instalación'; break;
