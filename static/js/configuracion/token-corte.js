$.ajax({
    type: "post",
    url: "../servidor/configuracion/token.php",
    data: "traer-token",
    dataType: "json",
...
function generarToken(){
    /* token = random() + random();
     ...
     Swal.fire({
         ...
         icon: 'info',
         html: 
         '<label >Ingrese el token de acceso para poder cambiar el monto de apertura</span><br><br>'+
                                         ...
                                         success: function (response) {
                                             ...
                                             if (response == 3) {
                                                 Swal.fire({
                                                     ...
                                                     html: "<span>Ahora puedes cambiar el monto de apertura</br></span>",   
                                                     icon: "success",
                                                     cancelButtonColor: '#00e059',
                                                     showConfirmButton: true,
                                                     ...
                                                     document.getElementById('apertura').disabled = false;
