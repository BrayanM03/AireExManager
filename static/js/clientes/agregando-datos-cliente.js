...
$state = $('<div class="row justify-content-center">'+
    '<div class="col-md-3"><img src="../../vistas/dist/img/ERP/bancos/'+state.id+'.jpg" style="width:50px"></div>'+
    '<div class="col-md-9">'+
    '<span>'+state.text+'</span><br>'+
    '<span style="font-size: 12px"><b>RFC:</b> '+state.id+'</span>'+
    '</div>'+
  '</div>');
